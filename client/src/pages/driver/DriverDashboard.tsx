...
import { Bus, Users, MessageSquare, MapPin, Clock, Calendar, AlertTriangle, TrendingUp } from 'lucide-react';
...
const DriverDashboard = () => {
    ...
    const [activeTab, setActiveTab] = useState<'overview' | 'bookings' | 'chat'>('overview');
    const [chatMessage, setChatMessage] = useState('');
    const [messages, setMessages] = useState<Message[]>([
        { id: '1', sender: 'Admin', text: 'Good morning! Ready for today\'s route?', time: '08:30 AM', isDriver: false },
        { id: '2', sender: 'You', text: 'Yes, all set!', time: '08:32 AM', isDriver: true },
        { id: '3', sender: 'Admin', text: 'Great! Have a safe journey.', time: '08:33 AM', isDriver: false },
    ]);
    ...
    const bookedSeats: BookedSeat[] = [
        { id: '1', seatNumber: 'A1', passengerName: 'Kamal Perera', phone: '0771234567', from: 'Pettah', to: 'Nugegoda', fare: 50 },
        { id: '2', seatNumber: 'A2', passengerName: 'Nimal Silva', phone: '0779876543', from: 'Borella', to: 'Homagama', fare: 80 },
        { id: '3', seatNumber: 'B1', passengerName: 'Sunil Fernando', phone: '0765432109', from: 'Pettah', to: 'Maharagama', fare: 70 },
        { id: '4', seatNumber: 'B2', passengerName: 'Amara Jayasinghe', phone: '0712345678', from: 'Kotte', to: 'Homagama', fare: 60 },
    ];
                ...
                <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl shadow-lg p-6 mb-6 text-white">
                    <div className="flex items-start justify-between">
                        ...
                        <div className="text-right">
                            <div className="text-3xl font-bold">{busDetails.bookedSeats}/{busDetails.totalSeats}</div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">{busDetails.totalSeats - busDetails.bookedSeats}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">{busDetails.departureTime}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        >
                            <div className="flex items-center justify-between mb-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="font-bold text-gray-900">Route Traffic Status</h3>
                                        <p className="text-sm text-gray-600">Real-time traffic conditions on your route</p>
                                    </div>
                                </div>
                            ...
                            <div className="mt-4 p-3 bg-white rounded-lg border border-orange-200">
                                <p className="text-xs text-orange-800">
                                    ⚠️ <strong>Alert:</strong> Heavy traffic detected at Kotte. Consider alternative route or inform passengers about delay.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="md:col-span-3 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl shadow-sm border border-green-200 p-6">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    <h3 className="font-bold text-gray-900">Today's Environmental Impact</h3>
                                    <p className="text-sm text-gray-600">SDG 11: Sustainable Cities & Communities</p>
                                </div>
                            </div>
                                ...
                                <tbody className="divide-y divide-gray-100">
                                    {bookedSeats.map((seat) => (
                                        <tr key={seat.id} className="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td className="px-6 py-4 font-medium text-gray-900">{seat.passengerName}</td>
                                            ...
                                            <td className="px-6 py-4 font-semibold text-gray-900">Rs. {seat.fare}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
                        ...
                        <div className="h-[500px] flex flex-col">
                            ...
                            <div className="flex-1 overflow-y-auto p-6 space-y-4">
                                {messages.map((message) => (
                                    ...
                                    >
                                        <div className={`max-w-xs ${message.isDriver ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-900'} rounded-2xl px-4 py-3`}>
                                            <p className="text-sm font-medium mb-1">{message.sender}</p>
                                            <p className="text-sm">{message.text}</p>
                                            <p className={`text-xs mt-1 ${message.isDriver ? 'text-blue-100' : 'text-gray-500'}`}>
                                                {message.time}
                                            </p>
                                        </div>
                                    </div>
